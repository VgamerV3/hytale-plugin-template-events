...
public final class EventsDemoCommand extends AbstractCommand {
  private final EventsPluginState state;
  private final EventsDemoService demoService;
  private final AtomicLong heartbeatTicks;

  public EventsDemoCommand(EventsPluginState state, EventsDemoService demoService, AtomicLong heartbeatTicks) {
    super("hdeventsdemo", "Runs a demo action for the Events template.");
