...
public final class EventsPluginState {
  private final AtomicReference<EventsPluginLifecycle> lifecycle = new AtomicReference<>(EventsPluginLifecycle.NEW);
  ...
  private volatile String templateName = "Events";
  private volatile String dataDirectory = "";

  public EventsPluginLifecycle getLifecycle() {
    return lifecycle.get();
  }

  public void setLifecycle(EventsPluginLifecycle next) {
    lifecycle.set(next);
  }
